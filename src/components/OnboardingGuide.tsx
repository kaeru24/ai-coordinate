...
const STEPS = [
  {
    icon: '🪡',
    title: 'MyClosetへようこそ',
    description: 'あなたのワードローブをデジタルで管理し、AIがコーデを提案してくれるアプリです。',
  },
  {
    icon: '📷',
    title: '服を登録する',
    description: 'トップスとボトムスの写真を撮って登録します。クローゼットにアイテムが増えるほど、コーデの幅が広がります。',
  },
  {
    icon: '🪞',
    title: 'コーデを作る',
    description: 'アイテムを選んでコーデを確認。AIに任せれば、ワードローブからベストなコーデを自動で生成してくれます。',
  },
  {
    icon: '✨',
    title: 'さっそく始めよう',
    description: 'まずは服を1枚登録してみましょう。写真を撮るだけで簡単に追加できます。',
  },
];
